...
sap.uiext.inbox.SubstitutionRulesManager.prototype.getSubstitutionRulesData = function(oModel) {
	if (this.bUseBatch) {
		...
		this._fetchSubstitutionRuleCollectionData(oModel);
	} else {
		/*
...
sap.uiext.inbox.SubstitutionRulesManager.prototype._getSubstitutesRulesData = function(oModel) {
	if (this.bUseBatch) {
		...
		this._fetchSubstitutesRuleCollectionData(oModel);
	} else {
		/*
...
sap.uiext.inbox.SubstitutionRulesManager.prototype._fetchSubstitutionRuleCollectionData = function(oModel) {
	var that = this;
	oModel.read("/SubstitutionRuleCollection", null, null, true, function(oData,oResponse) {
...
sap.uiext.inbox.SubstitutionRulesManager.prototype._fetchSubstitutesRuleCollectionData = function(oModel) {
	var that = this;
	oModel.read("/SubstitutesRuleCollection", null, null, true, function(oData,oResponse) {
...
sap.uiext.inbox.SubstitutionRulesManager.prototype.deleteSubstitutionRule = function(oEvent, that) {
	...
	var oParentModel = that.getModel();
	...
	oParentModel.callFunction(that.substitutionConstants.deleteRuleExecutionFunctionImport, "POST", oDeleteEntry, null, function(data, request) {
...
sap.uiext.inbox.SubstitutionRulesManager.prototype.updateSubstitutionRule = function(oEvent, that, bEnable) {
	...
	oParentModel.callFunction(that.substitutionConstants.updateRuleExecutionFunctionImport, "POST", oUpdateEntry, null, function(data, request) {
...
sap.uiext.inbox.SubstitutionRulesManager.prototype._handleSearchUsersClickforCreateSubstitution = function(oEvent){
	...
	if (this.bSystemInfoAvailable) {
		...
		if (!this.bSystemInfoModelDataSet) {
			this._fetchSystemInfoCollectionModelData();
		}
	...
	return this._searchUsers({
		sSearchTerm: oEvent.getParameter("query").trim(),
...
sap.uiext.inbox.SubstitutionRulesManager.prototype._sendCreateRuleRequestWithProfile= function(oSubRuleMgr,oEntry){
	...
	var aSelectedProviders = this._getProvidersForCreateSubstitution(oEntry);
...
sap.uiext.inbox.SubstitutionRulesManager.prototype.openSubstProfileDialog = function(oEvent, oSubRuleMgr){
	...
	var dynamicId = oSubRuleMgr.getId() + '--';
	var oSubProfileData = oSubRuleMgr._getSubstProfileData();
...
sap.uiext.inbox.SubstitutionRulesManager.prototype._getSubstProfileData = function(){
	if (!oModel) {
		var oModel = this.getModel();
	}
	var that = this;
	if (!this.oSubstitutionProfileData) {
		oModel.read("/SubstitutionProfileCollection", null, null, false, function(oData,oResponse) {
	...
	return this.oSubstitutionProfileData;
	
};

sap.uiext.inbox.SubstitutionRulesManager.prototype._getSystemInfoCollectionData = function(){
	var oModel = this.getModel();
	var that = this;
	var oSystemData = false;
	oModel.read("/SystemInfoCollection", null, null, false, function(oData,oResponse) {
		oSystemData = oData;
	}, function(error) {
...
sap.uiext.inbox.SubstitutionRulesManager.prototype._getProvidersForCreateSubstitution = function(oEntry){
...
sap.uiext.inbox.SubstitutionRulesManager.prototype._createSubRuleWithProfileBatch = function(oEntry, aSelectedProviders) {
	...
	jQuery.each(aSelectedProviders, function(i, item) {
		...
		var oBatchOperation = oModel.createBatchOperation(that.sPath,"POST", oTempEntry);
...
sap.uiext.inbox.SubstitutionRulesManager.prototype._fetchSystemInfoCollectionModelData = function() {
	
	var oSystemInfoData = [];
	var oSystemsData = this._getSystemInfoCollectionData();
