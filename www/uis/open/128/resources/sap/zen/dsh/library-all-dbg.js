...
if ( !jQuery.sap.isDeclared('sap.zen.dsh.LumiraLaunchpadViewer') ) {
...
}; // end of sap/zen/dsh/LumiraLaunchpadViewer.js
...
/**
 * Initialization Code and shared classes of library sap.zen.dsh (14.0.1-SNAPSHOT)
 */
jQuery.sap.declare("sap.zen.dsh.library");
jQuery.sap.require('sap.ui.core.Core'); // unlisted dependency retained

/**
 * [Enter description for sap.zen.dsh]
 *
 * @namespace
 * @name sap.zen.dsh
 * @public
...
jQuery.sap.require('sap.zen.crosstab.Crosstab'); // unlisted dependency retained
