...
sap.zen.crosstab.DataCell.prototype.init=function(){"use strict";this.aStyles=[];this.addStyle(sap.zen.crosstab.rendering.RenderingConstants.STYLE_DATA_CELL);this.bLoading=false;this.bIsEntryEnabled=false;this.sUnit="";this.sPassiveCellType=sap.zen.crosstab.rendering.RenderingConstants.PASSIVE_CELL_TYPE_NORMAL;this.bTextHasLineBreaks=false};
...
sap.zen.crosstab.DataCell.prototype.getCssClassNames=function(i){return sap.zen.crosstab.CellStyleHandler.getCssClasses(this.aStyles,i)};
...
sap.zen.crosstab.DataCell.prototype.setTextHasLineBreaks=function(t){this.bTextHasLineBreaks=t};
sap.zen.crosstab.DataCell.prototype.textHasLineBreaks=function(){return this.bTextHasLineBreaks};
