(function () {
    ...
    jQuery.sap.declare( "uniorg.bonvendo.ui.ushell.utils" );
     ...
     * @since 1.15.0
     */
    uniorg.bonvendo.ui.ushell.utils.Error = function ( sMessage, sComponent ) {
        this.name = "uniorg.bonvendo.ui.ushell.utils.Error";
        this.message = sMessage;
        jQuery.sap.log.error( sMessage, null, sComponent );
    };

    uniorg.bonvendo.ui.ushell.utils.Error.prototype = new Error();
     ...
     * @private
     */
    uniorg.bonvendo.ui.ushell.utils.localStorageSetItem = function ( sKey, sValue, bLocalEvent ) {
        var oEvent;
        try {
     ...
     * @since 1.15.0
     */
    uniorg.bonvendo.ui.ushell.utils.Map = function () {
        this.entries = {};
    };
     ...
     * @since 1.15.0
     */
    uniorg.bonvendo.ui.ushell.utils.Map.prototype.put = function ( sKey, vValue ) {
     ...
     * @since 1.15.0
     */
    uniorg.bonvendo.ui.ushell.utils.Map.prototype.containsKey = function ( sKey ) {
        if ( typeof sKey !== "string" ) {
            throw new uniorg.bonvendo.ui.ushell.utils.Error( "Not a string key: " + sKey, "uniorg.bonvendo.ui.ushell.utils.Map" );
        }
     ...
     * @since 1.15.0
     */
    uniorg.bonvendo.ui.ushell.utils.Map.prototype.get = function ( sKey ) {
     ...
     * @since 1.15.0
     */
    uniorg.bonvendo.ui.ushell.utils.Map.prototype.keys = function () {
     ...
     * @since 1.17.1
     */
    uniorg.bonvendo.ui.ushell.utils.Map.prototype.remove = function ( sKey ) {
     ...
     * @since 1.15.0
     */
    uniorg.bonvendo.ui.ushell.utils.Map.prototype.toString = function () {
        var aResult = ['uniorg.bonvendo.ui.ushell.utils.Map('];
     ...
     *   <code>uniorg.bonvendo.ui.ushell.utils.testPublishAt</code> only in exceptional cases!
     * @since 1.15.0
     */
    uniorg.bonvendo.ui.ushell.utils.testPublishAt = function ( o, sExternalFunctionName ) {
     ...
     */
    uniorg.bonvendo.ui.ushell.utils.handleTilesVisibility = function () {
        ...
        visibilityCalcTimer = setTimeout( function () {
            ...
            // Get the visible and non-visible Tiles
                aTiles = uniorg.bonvendo.ui.ushell.utils.getVisibleTiles();

            if ( (typeof aTiles != "undefined") && aTiles.length > 0 ) {
                var launchPageService = sap.ushell.Container.getService( "LaunchPage" );

                aTiles.forEach( function ( oTile ) {
                    launchPageService.setTileVisible( uniorg.bonvendo.ui.ushell.utils.getTileObject( oTile ), oTile.isDisplayedInViewPort );
                } );
                jQuery.sap.log.debug( "Visible Tiles: " + aTiles.filter( function ( oTile ) {
                    return oTile.isDisplayedInViewPort;
                } ).length );
                jQuery.sap.log.debug( "NonVisible Tiles: " + aTiles.filter( function ( oTile ) {
                    return !oTile.isDisplayedInViewPort;
                } ).length );
            }
     ...
     */
    uniorg.bonvendo.ui.ushell.utils.setTilesNoVisibility = function () {
        ...
        var aTiles = uniorg.bonvendo.ui.ushell.utils.getVisibleTiles();
        if ( (typeof aTiles !== "undefined") && aTiles.length > 0 ) {
            var launchPageService = sap.ushell.Container.getService( "LaunchPage" );

            aTiles.forEach( function ( oTile ) {
                launchPageService.setTileVisible( uniorg.bonvendo.ui.ushell.utils.getTileObject( oTile ), false );
            } );
            jQuery.sap.log.debug( "Visible Tiles: " + aTiles.filter( function ( oTile ) {
                return oTile.isDisplayedInViewPort;
            } ).length );
     ...
     */
    uniorg.bonvendo.ui.ushell.utils.getBasicHash = function ( hash ) {
        // Check hash validity
        if ( !uniorg.bonvendo.ui.ushell.utils.validHash( hash ) ) {
    ...
    uniorg.bonvendo.ui.ushell.utils.validHash = function ( hash ) {
        return (hash && hash.constructor === String && $.trim( hash ) != "");
    };

    uniorg.bonvendo.ui.ushell.utils.handleTilesOpacity = function () {
    ...
    uniorg.bonvendo.ui.ushell.utils.convertToRealOpacity = function ( amountOfUsage, max ) {
    ...
    uniorg.bonvendo.ui.ushell.utils.hexToRgb = function ( hex ) {
     ...
     */
    uniorg.bonvendo.ui.ushell.utils.getVisibleTiles = function () {
    ...
    uniorg.bonvendo.ui.ushell.utils.getTileObject = function ( ui5TileObject ) {
        var bindingContext = ui5TileObject.getBindingContext();
        return bindingContext.getObject().object;
    };

    uniorg.bonvendo.ui.ushell.utils.addBottomSpace = function () {
    ...
    uniorg.bonvendo.ui.ushell.utils.groupHasVisibleTiles = function ( groupTiles ) {
